...
public class DaoParam {
	...
	public final static String DM_CONTEXT_PERSISTANCE  		= "DMhibernate";
	public final static String ID_CONTEXT_PERSISTANCE  		= "IDMhibernateXE";
	public final static String CONTEXT_PERSISTANCE2  		= "MapGyver";
