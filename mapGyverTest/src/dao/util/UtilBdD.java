...
public class UtilBdD {
	...
	public static final String ENTITY_VOYPOI 				= "mpg_voy_poi";
	public static final String ENTITY_POINT_INTERET			= "mpg_poi";
	...
	public static final String ENTITY_COORDONNEE			= "mpg_coord";
}
