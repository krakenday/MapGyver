...
<ul class="sidebar navbar-nav">
  ...
  <!--        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="<%=request.getContextPath()%>/mpg/login.jsp">Info utilisateur</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="<%=request.getContextPath()%>/mpg/login.jsp">Mes groupes</a>
            <a class="dropdown-item" href="<%=request.getContextPath()%>/mpg/register.jsp">Mes listes de diff</a>
            <div class="dropdown-divider"></div>
          </div>
        </li>
  -->
