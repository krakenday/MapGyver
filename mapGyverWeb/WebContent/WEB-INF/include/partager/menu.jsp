...
<div class="sidebar" data-color="purple" data-image="<%=request.getContextPath()%>/assets/img/sidebar-2.jpg">
    ...
    -->
   	...
   	<div class="sidebar-wrapper">
           ...
           <ul class="nav">
               <li class="active">
                   <a class="btnMenu" href="<%= request.getContextPath() %>/vue/vue.partager/dashboard.jsp">
                    <i class="pe-7s-graph"></i>
                    <p>MENU</p>
                   </a>
               </li>
               <li>
                   <a class="btnVoyage" href="<%= request.getContextPath() %>/vue/vue.partager/voyage.jsp">
               ...
               <li>
                   <a class="btnPointInteret" href="<%= request.getContextPath() %>/vue/vue.partager/pointInteret.jsp">
